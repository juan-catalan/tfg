...
class CoverageMeasurementTest {
    ...
    void testCoberturaTodosCaminosCurso2122Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2122.Convocatoria1 convocatoria1 = new org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2122.Convocatoria1();
    ...
    void testCoberturaTodosCaminosCurso2223Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2223.Convocatoria1 convocatoria1 = new org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2223.Convocatoria1();
        // Obtener identificador
    ...
    void testCoberturaTodosCaminosCurso1920Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1920.Convocatoria1 convocatoria1 = new org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1920.Convocatoria1();
        // Obtener identificador
    ...
    void testCoberturaTodosCaminosCurso1617Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1617.Convocatoria1 convocatoria1 = new org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1617.Convocatoria1();
        // Obtener identificador
        String descriptorMetodo = Type.getMethodDescriptor(convocatoria1.getClass().getMethod("buscar", int[].class, int.class));
        String idMetodo = getClassName(convocatoria1.getClass()).concat("." + "buscar").concat("." + descriptorMetodo);
        // Ejecutar metodo
    ...
    void testCoberturaTodosCaminosCurso1516Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1516.Convocatoria1 convocatoria1 = new org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1516.Convocatoria1();
        // Obtener identificador
    ...
    void testCoberturaTodosCaminosCurso1415Convocatoria1() throws NoSuchMethodException {
        // Obtener clase
        Convocatoria2 convocatoria2 = new Convocatoria2();
        // Obtener identificador
