...
class ObtenerSituacionesPruebaTest {
    ...
    void testCurso1415Convocatoria2() {
        verificarNumSituacionesPrueba(Convocatoria2.class,
                "imagen", 10);
    }

    @Test
    void testCurso1516Convocatoria1() {
        verificarNumSituacionesPrueba(org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1516.Convocatoria1.class,
                "esPrimo", 12);
    }

    @Test
    void testCurso1617Convocatoria1() {
        verificarNumSituacionesPrueba(org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1617.Convocatoria1.class,
                "buscar", 10);
    }

    @Test
    void testCurso1819Convocatoria1() {
        verificarNumSituacionesPrueba(Convocatoria1.class,
                "buscar", 12);
    }

    @Test
    void testCurso1920Convocatoria1() {
        verificarNumSituacionesPrueba(org.juancatalan.edgepaircoverage.ejerciciosExamen.curso1920.Convocatoria1.class,
                "minimo", 11);
    }

    @Test
    void testCurso2122Convocatoria1() {
        verificarNumSituacionesPrueba(org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2122.Convocatoria1.class,
                "replaceDigits", 12);
    }

    @Test
    void testCurso2223Convocatoria1() {
        verificarNumSituacionesPrueba(org.juancatalan.edgepaircoverage.ejerciciosExamen.curso2223.Convocatoria1.class,
